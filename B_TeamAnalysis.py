...
#Team - global variable
team = str

#Setting the team specific statistics
def setTeamStats():
    global team
    global team_stats
    global season_stats
    season_stats = pd.read_csv("season_stats_b.csv")
    temp = pd.DataFrame()
...
#Function to calculate cumulative season points
...
#Function to calculate season points of a team
...
#Function to set predicted season points of a team
